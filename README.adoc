...
image:https://travis-ci.com/metanorma/isodoc-rice.svg?branch=master["Build Status", link="https://travis-ci.org/metanorma/isodoc-rice"]

This document is available in its rendered forms here:

* https://metanorma.github.io/isodoc-rice/[ISO Rice document (repository)]
