...
image:https://github.com/metanorma/mn-samples-iso/workflows/publish/badge.svg["Build Status", link="https://github.com/metanorma/mn-samples-iso/actions?workflow=publish"]
